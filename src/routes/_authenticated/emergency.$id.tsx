...
export const Route = createFileRoute("/_authenticated/emergency/$id")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Complete emergency record: AI triage, dispatch, hospital and full timeline.",
      },
...
function EmergencyDetailPage() {
  ...
  const conditions = Object.entries(emergency.conditions).filter(
        ...
        <div className="space-y-6">
          <section className="card-surface space-y-4 p-6">
            ...
            <dl className="grid gap-3 text-sm sm:grid-cols-3">
              ...
              <div className="sm:col-span-3">
                ...
                <dd>
                  {emergency.address ?? "Unknown"} ({emergency.latitude.toFixed(4)},{" "}
          ...
          <section className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="card-surface space-y-3 p-5">
              ...
              <p className="text-sm">
                Ambulance:{" "}
                <span className="font-medium">{ambulance?.ambulance_number ?? "Not assigned"}</span>
              </p>
              <p className="text-sm">
